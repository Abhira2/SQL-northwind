-- 1) Create a database, say, named northwind, in pgadmin
-- 2) Launch the query tool (right click at the database), and open this script.
-- 3) Once this script is open, one can run it to create the tables and populate the records
